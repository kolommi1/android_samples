...
public class MainActivity extends Activity {
    ...
    private void addButtonsToRelativeLayout(RelativeLayout layout ){
        ...
        modeButton.setText(R.string.btn_mode);
        modeButton.setId(R.id.btn_mode);
        ...
        modeButton.setOnClickListener(sample_GL_View.buttonListener);
        layout.addView(modeButton);

        //Button First person
        Button polygonButton = new Button(this);
        polygonButton.setText(R.string.btn_polygons);
        polygonButton.setId(R.id.btn_polygons);

        params = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT,
                RelativeLayout.LayoutParams.WRAP_CONTENT);
        params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        params.addRule(RelativeLayout.BELOW, R.id.btn_mode);
        polygonButton.setLayoutParams(params);

        polygonButton.setOnClickListener(sample_GL_View.buttonListener);
        layout.addView(polygonButton);
    }
}
