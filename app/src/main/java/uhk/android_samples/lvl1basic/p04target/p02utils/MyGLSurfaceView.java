...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    private uhk.android_samples.lvl1basic.p04target.p02utils.Renderer renderer;
    ...
    public void setRenderer(uhk.android_samples.lvl1basic.p04target.p02utils.Renderer renderer) {
