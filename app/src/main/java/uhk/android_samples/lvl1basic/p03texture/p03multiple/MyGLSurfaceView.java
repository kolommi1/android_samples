...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    private uhk.android_samples.lvl1basic.p03texture.p03multiple.Renderer renderer;
    ...
    public void setRenderer(uhk.android_samples.lvl1basic.p03texture.p03multiple.Renderer renderer) {
