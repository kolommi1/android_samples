...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    private uhk.android_samples.lvl2advanced.p04target.p02draw.Renderer renderer;
    ...
    public void setRenderer(uhk.android_samples.lvl2advanced.p04target.p02draw.Renderer renderer) {
