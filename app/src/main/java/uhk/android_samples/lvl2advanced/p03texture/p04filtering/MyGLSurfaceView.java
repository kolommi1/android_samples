...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    private uhk.android_samples.lvl2advanced.p03texture.p04filtering.Renderer renderer;
    private float ox, oy;
    ...
    public void setRenderer(uhk.android_samples.lvl2advanced.p03texture.p04filtering.Renderer renderer) {
    ...
    public OnClickListener buttonListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            if(id == R.id.btn_tex_mode){
                renderer.changeTexMode();
            }
            if(id == R.id.btn_tex_source){
                renderer.changeTexSource();
            }
            if(id == R.id.btn_interpolation){
                renderer.changeInterMode();
            }
