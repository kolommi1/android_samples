...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    private uhk.android_samples.lvl2advanced.p03texture.p02cubetexture.Renderer renderer;
    private float ox, oy;
    ...
    public void setRenderer(uhk.android_samples.lvl2advanced.p03texture.p02cubetexture.Renderer renderer) {
